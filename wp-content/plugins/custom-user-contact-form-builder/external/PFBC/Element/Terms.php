 ...
 * @author CMSHelplive
 */
class CM_Element_Terms extends CM_Element {
    private $terms;
   ...
   public function render()
    {       
       ...
       if($this->required_scroll==1){
           $scroll = "onscroll='cm_scroll_down_end(this);' ";
           $disabled='disabled';
       }
       ...
       $checked = '';
        ...
        echo "<div class='cm_terms_checkbox'><input $checked $disabled value='on' type='checkbox'", $this->getAttributes(array("default_value", "value")),  " class='cm_check_box'>".$cb_label."</div>";
        
           echo "<div id='cm_terms_textarea' class='cm_terms_textarea'><textarea ", $style ," ",$scroll," readonly  id='cm_terms_area_", $this->_attributes['name'], "' class='cm_terms_area'>";
