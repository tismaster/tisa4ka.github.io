 ...
 * @author cmshelplive
 */
class CM_Submission_Fields extends CM_Base_Model
{
...
//    }
    ...
    public function insert_into_db($force = false)
    {
        ...
        $result = CM_DBManager::insert_row('SUBMISSION_FIELDS', $data, $data_specifiers);
    ...
    public function update_into_db()
    {
        ...
        $result = CM_DBManager::update_row('SUBMISSION_FIELDS', $this->sub_field_id, $data, $data_specifiers);
    ...
    public function load_from_db($sub_field_id, $should_set_id = true)
    {
        ...
        $result = CM_DBManager::get_row('SUBMISSION_FIELDS', $sub_field_id);
    ...
    {
        return CM_DBManager::remove_row('SUBMISSION_FIELDS', $this->sub_field_id);
    }
