...
class CM_Attachment_Service extends CM_Services {
    /*
    ...
    public function get_all_form_attachments($form_id, $return_type = 'ids', $limit = false) {
        ...
        $attachments = CM_DBManager::get_all_form_attachments($form_id);
        ...
        if ($attachments) {
            ...
            foreach ($attachments as $key => $attachment) {
                ...
                if (isset($attachment['cm_field_type']))
                    unset($attachment['cm_field_type']);
     ...
     * 
     * As per our need this function creates a zip file with name 'cm_attachments.zip' in Temp_Files
    ...
    public function get_zip(array $attachment_ids) {
        ...
        $file_name = 'cm_attachments' . time() . mt_rand(10, 1000000);
