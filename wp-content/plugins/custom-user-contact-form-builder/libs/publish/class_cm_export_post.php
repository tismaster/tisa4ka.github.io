...
require_once plugin_dir_path(__FILE__) . 'interface_cm_exporter.php';

/**
 * Description of class_cm_export_post
 *
 * @author CMSHelplive
 */
class CM_Export_POST implements CM_Exporter
{
    ...
    public function prepare_data($data_raw)
    {
        foreach ($data_raw as $data_row)
        {
            ...
            {
                if (isset($data_row->value['cm_field_type']) && $data_row->value['cm_field_type'] == 'File')
                {
                    unset($data_row->value['cm_field_type']);
                ...
                }elseif (isset($data_row->value['cm_field_type']) && $data_row->value['cm_field_type'] == 'Address'){
                       unset($data_row->value['cm_field_type']);
