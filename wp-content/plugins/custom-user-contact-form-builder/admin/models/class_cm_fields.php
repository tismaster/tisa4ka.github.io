 ...
 * @author cmshelplive
 */
class CM_Fields extends CM_Base_Model
{
    ...
    public function set_field_options($options)
    {
        ...
        $this->field_options = CM_Utilities::merge_object($field_options, $this->field_options);
    }
    ...
    public function insert_into_db()
    {
        ...
        $result = CM_DBManager::insert_row('FIELDS', $data, $data_specifiers);
    ...
    public function update_into_db()
    {
        ...
        $result = CM_DBManager::update_row('FIELDS', $this->field_id, $data, $data_specifiers);
    ...
    public function load_from_db($field_id, $should_set_id = true)
    {
        ...
        $result = CM_DBManager::get_row('FIELDS', $field_id);
    ...
    {
        return CM_DBManager::remove_row('FIELDS', $this->field_id);
    }
