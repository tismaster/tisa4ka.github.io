<?php
class CM_Element_Radio extends CM_OptionElement {
...
JS;
	...
	public function render() { 
		$labelClass = 'cmradio';//$this->_attributes["type"];
		...
		foreach($this->options as $value => $text) {
			...
			++$count;
                ...
                if(isset($this->_attributes["cm_is_other_option"]) && $this->_attributes["cm_is_other_option"] == 1){                       //get value of "other" field to be prefilled if provided.
                    $other_val = '';
