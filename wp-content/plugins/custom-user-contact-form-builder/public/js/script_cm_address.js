...
function cmAutocomplete(curr_id) {
    ...
    this.cmInitAutocomplete = function () {
...
if (typeof cm_prevent_submission !== 'function') {
    function cm_prevent_submission(event) {
