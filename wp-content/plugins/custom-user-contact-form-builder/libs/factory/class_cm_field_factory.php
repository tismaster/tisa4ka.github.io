...
/**
 * Description of CM_Field_Factory
 *
 */
class CM_Field_Factory {
    ...
    public function __construct($db_field,$opts){
     ...
     public function create_binfo_field(){
       ...
       return new CM_Frontend_Field_Base($this->db_field->field_id, $this->db_field->field_type, $this->db_field->field_label, $this->opts, $this->db_field->page_no, $this->db_field->is_field_primary, $this->x_opts);
    ...
    public function create_price_field(){
        ...
        return new CM_Frontend_Field_Price($this->db_field->field_id, $this->db_field->field_label, $this->opts, $this->db_field->field_value, $currency_pos, $currency_symbol, $this->db_field->page_no, $this->db_field->is_field_primary, $this->x_opts); 
    }
    ...
    public function create_select_field(){
        return new CM_Frontend_Field_Select($this->db_field->field_id, $this->db_field->field_label, $this->opts, $this->db_field->field_value, $this->db_field->page_no, $this->db_field->is_field_primary, $this->x_opts);
    }
    ...
    public function create_base_field(){
        return new CM_Frontend_Field_Base($this->db_field->field_id,'Textbox', $this->db_field->field_label, $this->opts, $this->db_field->page_no, $this->db_field->is_field_primary, $this->x_opts);
    }
    ...
    public function create_nickname_field(){
       ...
       return new CM_Frontend_Field_Base($this->db_field->field_id,'Nickname', $this->db_field->field_label, $this->opts, $this->db_field->page_no, $this->db_field->is_field_primary, $this->x_opts);
    }
    ...
    public function create_website_field(){
        ...
        return new CM_Frontend_Field_Base($this->db_field->field_id,'Website', $this->db_field->field_label, $this->opts, $this->db_field->page_no, $this->db_field->is_field_primary, $this->x_opts);
    }
    ...
    public function create_terms_field(){
        ...
        return new CM_Frontend_Field_Terms($this->db_field->field_id, $this->db_field->field_label, $this->opts, $this->db_field->field_value, $this->db_field->page_no, $this->db_field->is_field_primary, $this->x_opts);
    }
    ...
    public function create_radio_field(){
        return new CM_Frontend_Field_Radio($this->db_field->field_id, $this->db_field->field_label, $this->opts, $this->db_field->field_value, $this->db_field->page_no, $this->db_field->is_field_primary, $this->x_opts);
    }
    
    public function create_checkbox_field(){
        return new CM_Frontend_Field_Checkbox($this->db_field->field_id, $this->db_field->field_label, $this->opts, $this->db_field->field_value, $this->db_field->page_no, $this->db_field->is_field_primary, $this->x_opts);
    }
    ...
    public function create_htmlh_field(){
        return new CM_Frontend_Field_Visible_Only($this->db_field->field_id, $this->db_field->field_type, $this->db_field->field_label, $this->opts, $this->db_field->field_value, $this->db_field->page_no, $this->db_field->is_field_primary, $this->x_opts);
    }
