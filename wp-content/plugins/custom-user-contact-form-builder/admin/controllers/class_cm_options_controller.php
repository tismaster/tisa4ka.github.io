...
class CM_Options_Controller
{
    ...
    public function manage($model, CM_Setting_Service $service, $request, $params)
    {
        $view = $this->mv_handler->setView('options_manager');
        $view->render();
    }

    public function general(CM_Options $model, CM_Setting_Service $service, $request, $params)
    {
    ...
    public function fab(CM_Options $model, CM_Setting_Service $service, $request, $params)
    {
        return;
    }

    public function security($model, CM_Setting_Service $service, $request, $params)
    {
    ...
    public function thirdparty($model, CM_Setting_Service $service, $request, $params)
    {
    ...
    public function payment($model, CM_Setting_Service $service, $request, $params)
    {
