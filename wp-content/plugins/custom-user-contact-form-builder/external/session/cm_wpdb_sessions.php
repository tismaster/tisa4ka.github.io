...
class CM_WPDB_Session_Handler {
	public static $instance = null;
	public static $config = null;

	public $wpdb = null;
	public $table = 'cm_sessions';
	public $version = 1;
	...
	public static function init() {     
		...
		if ( ! self::$instance ) { 
			self::$instance = new CM_WPDB_Session_Handler;
			self::$instance->wpdb = $GLOBALS['wpdb']; 
			CM_Table_Tech::create_session_table();
