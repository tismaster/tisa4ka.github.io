 ...
 * @author CMSHelplive.
 */
class CM_Notes extends CM_Base_Model
{
...
//                   'type' => $this->type,
            'status' => $this->status,
            'publication_date' => CM_Utilities::get_current_time(),
        ...
        $result = CM_DBManager::insert_row('NOTES', $data, $data_specifiers);
...
//                  'type' => $this->type,
            'status' => $this->status,
            'last_edit_date' => CM_Utilities::get_current_time(),
        ...
        $result = CM_DBManager::update_row('NOTES', $this->note_id, $data, $data_specifiers);
    ...
    public function load_from_db($note_id, $should_set_id = true)
    {
        ...
        $result = CM_DBManager::get_row('NOTES', $note_id);
...
//                $this->type = $result->type;
    ...
    {
        return CM_DBManager::remove_row('NOTES', $this->note_id);
    }
