 ...
 * @author CMSHelplive
 */
class CM_Dashboard_Widget_Service extends CM_Services
{
    public function get_count_summary()
    {
        ...
        $c1 = CM_DBManager::get_generic('SUBMISSIONS', $Q, $WQ_today);
        $c2 = CM_DBManager::get_generic('SUBMISSIONS', $Q, $WQ_week);
        $c3 = CM_DBManager::get_generic('SUBMISSIONS', $Q, $WQ_month);
