...
/**
 * Description of CM_Front_Users
 *
 * @author CMSHelplive
 */
class CM_Front_Users extends CM_Base_Model
{
    ...
    public function insert_into_db()
    {
        ...
        $data = array(
            ...
            'last_activity_time' => CM_Utilities::get_current_time(),
            'created_date' => CM_Utilities::get_current_time(),
        );
        ...
        $result = CM_DBManager::insert_row('FRONT_USERS', $data, $data_specifiers);
    ...
    public function update_into_db()
    {
        ...
        $result = CM_DBManager::update_row('FRONT_USERS', $this->field_id, $data, $data_specifiers);
    ...
    public function load_from_db($id, $should_set_id = true)
    {
        ...
        $result = CM_DBManager::get_row('FRONT_USERS', $field_id);
    ...
    {
        return CM_DBManager::remove_row('FRONT_USERS', $this->field_id);
    }
