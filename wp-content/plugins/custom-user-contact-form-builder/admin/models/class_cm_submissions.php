 ...
 * @author cmshelplive
 */
class CM_Submissions extends CM_Base_Model
{
  ...
  public function get_submission_ip()
    {
       ...
       $sub_ip=  CM_DBManager::get('STATS', $where,array('%d'), 'col', 0,1,'user_ip');
    ...
    public function get_submission_browser()
    {
       ...
       $sub_id = $service->get_oldest_submission_from_group($this->submission_id);
       $where=array('submission_id'=>$sub_id);
       $sub_bw=  CM_DBManager::get('STATS', $where,array('%d'), 'col', 0,1,'browser_name');
    ...
    {
        return CM_Utilities::strip_slash_array(maybe_unserialize($this->data));
    }
...
//    }
    ...
    public function insert_into_db()
    {
        ...
        $result = CM_DBManager::insert_row('SUBMISSIONS', $data, $data_specifiers);
    ...
    public function update_into_db()
    {
        ...
        $result = CM_DBManager::update_row('SUBMISSIONS', $this->submission_id, $data, $data_specifiers);
    ...
    public function load_from_db($submission_id,$should_set_id=true)
    {
        ...
        $result = CM_DBManager::get_row('SUBMISSIONS', $submission_id);
    ...
    {
        return CM_DBManager::remove_row('SUBMISSIONS', $this->submission_id);
    }
