 ...
 * @author cmshelplive
 */
class CM_PayPal_Fields extends CM_Base_Model
{
    ...
    public function insert_into_db()
    {
        ...
        $result = CM_DBManager::insert_row('PAYPAL_FIELDS', $data, $data_specifiers);
    ...
    public function update_into_db()
    {
        ...
        $result = CM_DBManager::update_row('PAYPAL_FIELDS', $this->field_id, $data, $data_specifiers);
    ...
    public function load_from_db($field_id, $should_set_id = true)
    {
        ...
        $result = CM_DBManager::get_row('PAYPAL_FIELDS', $field_id);
        //var_dump($result);die;
        if (null !== $result)
        {
            if ($should_set_id)
    ...
    {
        return CM_DBManager::remove_row('PAYPAL_FIELDS', $this->field_id);
    }
